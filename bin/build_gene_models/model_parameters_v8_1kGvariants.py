...
SNP_ANNOTATION_FN = '1kG_variants_hg38.txt.gz'
...
INTER_DIR = '/dors/capra_lab/projects/ancient_human_predixcan/data/gtex_v8_data/'
OUTPUT_DIR = '/dors/capra_lab/projects/ancient_human_predixcan/data/v8_models/1kGvar_models/'
...
SNP_ANN_INTER_DIR = 'snp_anno_1kGvar/'
