...
GENE_ANNOTATION_FN = 'gencode.v12.annotation.gtf.gz'
...
EXPRESSION_RPKM = ['GTEx_Data_20150112_RNAseq_RNASeQCv1.1.8_gene_rpkm_gencodev12.gct.gz']
EXPRESSION_READS = ['GTEx_Data_20150112_RNAseq_RNASeQCv1.1.8_gene_reads_gencodev12.gct.gz']
